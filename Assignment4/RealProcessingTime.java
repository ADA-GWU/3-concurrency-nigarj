...
class RealTimeProcessing extends JFrame {
    ...
    public RealTimeProcessing(String imagePath, int squareSize, char processingMode) {
        ...
        frame = resizeImage(ImageUtils.openImage(imagePath), 800, 1000);
    ...
    private void processImageMultiThread() {
        ...
        for (int i = 0; i < numThreads; i++) {
            ...
            executorService.submit(() -> processRowsInRange(startY, endY));
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter image file path, square size, and processing mode (S for single-threaded, M for multi-threaded):");
